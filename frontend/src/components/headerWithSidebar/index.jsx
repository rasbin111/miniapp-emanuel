...
const navigationItems = [
    ...
    { "title": "Invoice Journal", "link": "/invoice-journal", "icon": <PiInvoiceFill /> },
    { "title": "Price List", "link": "/price-list", "icon": <GiPriceTag /> },
    { "title": "Multiple Invoicing", "link": "/multiple-invoicing", "icon": <PiInvoiceBold /> },
            ...
            <div>
                ...
                <div className='heading-container'>
                    <div className='heading-left-section'>
                        ...
                        <GiHamburgerMenu className="sidebar-burger-menu" onClick={() =>
                ...
                <div className="sidebar-main">
                    ...
                    <div className={showMenuItems ? "sidebar-menu-box sidebar-menu-list" : "sidebar-menu-box"}>

                        <h2> Menu </h2>
                        <nav className={showMenuItems ? "sidebar-navigation-items sidebar-nav-list" : "sidebar-navigation-items"}>
                            {
